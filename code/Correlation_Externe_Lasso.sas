...
/* Créer un tableau concataténé des fréquences */
...
data Lasso_freq2;
    set Lasso_freq2;
    /* Creer une colonne avec une séquence de 1 à  50 */
...
proc sgplot data=Lasso_freq2;
    ...
    xaxis label="Selected variables" discreteorder=data;
    yaxis label="Frequency";
    title "Frequency of variable selection (choose = AIC and stop = BIC)";
run;
...
proc sgplot data=nouveau_long;
    ...
    title "Extern Correlation Lasso (Stop = SBC)";
run;
